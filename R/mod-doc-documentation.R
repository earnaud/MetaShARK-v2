...
#'
#' @description This is the function in charge of the UI part of 'documentation'
#' module
#'
#' @importFrom shiny tagList tags fluidRow column selectInput actionButton icon
#' div uiOutput
...
#' @title documentation
#'
#' @description This is the function in charge of the server part of 'documentation'
#' module
#'
#' @importFrom shiny observeEvent renderText h3
